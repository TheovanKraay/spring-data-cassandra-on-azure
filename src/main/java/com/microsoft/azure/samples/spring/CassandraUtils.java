...
public class CassandraUtils {
    ...
    private String cassandraKeyspace = "keyspace";
    ...
    public Session getSession(String[] contactPoints, int port, CosmosRetryPolicy retryPolicy,
            CosmosLoadBalancingPolicy loadBalancingPolicy) throws KeyStoreException, NoSuchAlgorithmException,
    ...
    private void loadCassandraConnectionDetails() throws Exception {
        cassandraHost = config.getProperty("spring.data.cassandra.contact-points");
        cassandraPort = Integer.parseInt(config.getProperty("spring.data.cassandra.port"));
        cassandraUsername = config.getProperty("spring.data.cassandra.username");
        cassandraPassword = config.getProperty("spring.data.cassandra.password");
        cassandraKeyspace = config.getProperty("spring.data.cassandra.keyspace-name");
